...
export function createRequestManager(): RequestManager {
    ...
    function get<T>(url: string, params: string, normalCode = 200): Promise<T> {
        return new Promise((resolve, reject) => {
            ...
            console.log('huan-request', requestUrl)
            fetch(requestUrl, {
                method: "GET",
                headers: {
                ...
                .then((response) => {
                    console.log('huan-resp', response)
    ...
    function cmsGet<T>(url: string): Promise<T> {
        console.log('huan-cmsGet-url', url)
        return new Promise((resolve, reject) => {
            fetch(url)
