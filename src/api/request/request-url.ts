...
//筛选页接口
export const filterListUrl = BuildConfig.requestBaseUrl + '/filter/${primaryId}/tags?packageName=${packageName}&id=${secondaryId}'
export const filterContentsUrl = BuildConfig.requestBaseUrl + '/filter/contents?packageName=${packageName}&page=${page}&limit=${limit}'
