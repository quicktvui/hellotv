<template>
    <div :style="parentStyle" :class="['top_btns_root_css', { 'is-logo-right': logoRight, 'is-logo-left': logoLeft }]">
        <img-text-btn-view v-if="!$slots.btnItem" :icon-left="true" text="筛选" :focusable="true"
            style="width: 145px;height: 60px;margin-left: 10px;margin-right: 10px" name="top_screen_btn"
            ref="top_screen_btn" icon="ic_top_search.png" focus-icon="ic_top_search_focus.png" @click="onClick"
            @focus="onFocus" />
