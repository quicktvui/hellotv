  ...
  <qt-view class="search_center" :style="{width:centerWidth+'px'}" ref="search_center" @childFocus="childFocus"
    ...
    <qt-view class="search_center_view_list" name="search_center_view_list"
      ...
      <qt-list-view v-else class="list_view" :style="{width:centerWidth+'px'}" ref="listViewRef"
                    ...
                    @item-focused="onItemFocus"  @load-more="loadMore" :nextFocusRightSID="targetSid">
        <qt-view :type="1" :focusable="true" :focusScale="1" class="search_center_item" :style="{width:centerWidth+'px'}"
