<template>
  <div class="detail-root-view-css" :skipRequestFocus='true'>
    ...
    <media-player ref="mediaPlayerViewRef" class="detail-media-player-view-css" @onPlayerPlayMedia="onPlayerPlayMedia"
      @onPlayerPlaying="onPlayerPlaying" @onPlayerWindowTypeChanged="onPlayerWindowTypeChanged" />
