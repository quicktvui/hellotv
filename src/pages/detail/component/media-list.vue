<template>
    ...
    <div class="media-list-view-root-css" v-show="visible" :clipChildren="false" :clipPadding="false">
        ...
        <qt-media-series ref="mediaSeriesRef" class="media-series-root-css" :clipChildren="false"
            @load-data="onLoadData" @item-click="onItemClick" @item-focused="onItemFocused"
