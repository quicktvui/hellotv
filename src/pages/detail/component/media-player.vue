<template>
    <qt-column class="media-player-root-css">
        <es-player-manager ref="playerManager" :smallWindowWidth="890" :smallWindowHeight="500"
            :initPlayerWindowType="1" playerBackgroundColor="black" :playMediaAuto="false" :playerList="playerListRef"
