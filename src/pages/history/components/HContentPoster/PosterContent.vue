<template>
    <div :focusable="false" :duplicateParentState="true" class="content_box" flexStyle="${style}">
        <!--封面-->
        ...
        <text-view 
            ...
            :postDelay="200" gravity="centerVertical|left"
            style="z-index: 999;" flexStyle="${title.style}" text="${title.text}"
