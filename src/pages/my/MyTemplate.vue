...
import { CSSProperties, reactive, computed, ref, onBeforeUnmount, onMounted } from 'vue';
...
const updateData = async () => {
  ...
  console.log('lsj-updateData')
}
onMounted(()=>{
  console.log('onMouted-lsj-my-template')
})
onBeforeUnmount(()=>{
