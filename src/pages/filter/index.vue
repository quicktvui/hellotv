<template>
    <div class="screen-root-css" ref='screen_root'>
        ...
        <!-- 左侧列表-->
        <div v-if="false" class="screen-left-root-css">
            <!-- 背景-->
            <div class="screen-left-bg" :gradientBackground="{ colors: ['#0CFFFFFF', '#00FFFFFF'], orientation: 4 }" />
            <!-- 标题-->
            <qt-text class="screen-left-title" v-if="title" :fontSize="50" gravity="center" :lines="1"
                :focusable="false" :select="true" :ellipsizeMode="3" :paddingRect="[12, 0, 12, 0]" :text="title" />
            ...
            <qt-list-view class="screen-left-tags-root-css" :padding="'0,0,0,20'" sid="screen_left_tags"
                name='screen_left_tags' :autofocusPosition="defaultTagPosition" ref="leftTags" :clipChildren="false"
                :clipPadding="false" @item-focused="leftTagsItemFocus" :blockFocusDirections="['left', 'down']">
                <!-- 纯文字标题-->
