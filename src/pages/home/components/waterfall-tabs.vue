<template>
    <div class="waterfall-tab-root-css" :clipChildren="false" ref="waterfall_tab_root" :clipPadding="false">
        ...
        <qt-tabs ref="tabRef" :tabContentResumeDelay="200"
            :tabContentBlockFocusDirections="tabContentBlockFocusDirections" tabNavBarClass="qt-tabs-waterfall-tab-css"
            tabPageClass="qt-tabs-waterfall-css" :triggerTask="tabsTriggerTask" :outOfDateTime="5 * 60 * 1000"
            @onTabClick="onTabClick" :tabContentSwitchDelay='0' @onTabPageChanged="onTabPageChanged"
